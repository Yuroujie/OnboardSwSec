 ...
 */
#ifndef DEFAULT_SCHEDULER_BURST_APP_MSGDEFS_H
#define DEFAULT_SCHEDULER_BURST_APP_MSGDEFS_H

#include "common_types.h"
#include "scheduler_burst_app_fcncodes.h"

typedef struct SCHEDULER_BURST_APP_DisplayParam_Payload
{
    uint32 ValU32;                                    /**< 32 bit unsigned integer value */
    int16  ValI16;                                    /**< 16 bit signed integer value */
    char   ValStr[SCHEDULER_BURST_APP_MISSION_STRING_VAL_LEN]; /**< An example string */
} SCHEDULER_BURST_APP_DisplayParam_Payload_t;

typedef struct SCHEDULER_BURST_APP_SimTraffic_Payload
{
...
} SCHEDULER_BURST_APP_SimTraffic_Payload_t;

typedef struct SCHEDULER_BURST_APP_RunBurst_Payload
{
    uint16 Count;       /**< Number of simulated fast commands to process */
    uint16 SpacingMsec; /**< Inter-command spacing in milliseconds */
} SCHEDULER_BURST_APP_RunBurst_Payload_t;
...
typedef struct SCHEDULER_BURST_APP_HkTlm_Payload
{
...
} SCHEDULER_BURST_APP_HkTlm_Payload_t;
