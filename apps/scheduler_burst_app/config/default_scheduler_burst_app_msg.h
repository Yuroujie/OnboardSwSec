 ...
 *   message data types.
 *
 * This is a compatibility header for the "scheduler_burst_app_msg.h" file that has
 ...
 * dictionary tool.
 */
#ifndef DEFAULT_SCHEDULER_BURST_APP_MSG_H
#define DEFAULT_SCHEDULER_BURST_APP_MSG_H

#include "scheduler_burst_app_mission_cfg.h"
#include "scheduler_burst_app_msgdefs.h"
#include "scheduler_burst_app_msgstruct.h"
