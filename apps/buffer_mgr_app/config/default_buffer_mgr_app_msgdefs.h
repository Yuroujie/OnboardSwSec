 ...
 */
#ifndef DEFAULT_BUFFER_MGR_APP_MSGDEFS_H
#define DEFAULT_BUFFER_MGR_APP_MSGDEFS_H

#include "common_types.h"
#include "buffer_mgr_app_fcncodes.h"

typedef struct BUFFER_MGR_APP_StageData_Payload
{
...
typedef struct BUFFER_MGR_APP_HkTlm_Payload
{
