 ...
 * @file
 *
 * Common definitions for all buffer_mgr_app coverage tests
 */

#ifndef BUFFER_MGR_APP_COVERAGETEST_COMMON_H
#define BUFFER_MGR_APP_COVERAGETEST_COMMON_H
...
#endif /* BUFFER_MGR_APP_COVERAGETEST_COMMON_H */
