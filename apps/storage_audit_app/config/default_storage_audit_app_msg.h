 ...
 *   message data types.
 *
 * This is a compatibility header for the "storage_audit_app_msg.h" file that has
 ...
 * dictionary tool.
 */
#ifndef DEFAULT_STORAGE_AUDIT_APP_MSG_H
#define DEFAULT_STORAGE_AUDIT_APP_MSG_H

#include "storage_audit_app_mission_cfg.h"
#include "storage_audit_app_msgdefs.h"
#include "storage_audit_app_msgstruct.h"
