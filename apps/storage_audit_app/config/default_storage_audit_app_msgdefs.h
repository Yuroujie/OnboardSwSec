 ...
 */
#ifndef DEFAULT_STORAGE_AUDIT_APP_MSGDEFS_H
#define DEFAULT_STORAGE_AUDIT_APP_MSGDEFS_H

#include "common_types.h"
#include "storage_audit_app_fcncodes.h"

typedef struct STORAGE_AUDIT_APP_StageData_Payload
{
    uint32 Amount; /**< Amount of buffered data to stage */
} STORAGE_AUDIT_APP_StageData_Payload_t;

typedef struct STORAGE_AUDIT_APP_CopyStore_Payload
{
    ...
    uint8  Reserved[3];
} STORAGE_AUDIT_APP_CopyStore_Payload_t;
...
typedef struct STORAGE_AUDIT_APP_HkTlm_Payload
{
...
} STORAGE_AUDIT_APP_HkTlm_Payload_t;
