 ...
 * @file
 *
 * Common definitions for all periodic_task_app coverage tests
 */

#ifndef PERIODIC_TASK_APP_COVERAGETEST_COMMON_H
#define PERIODIC_TASK_APP_COVERAGETEST_COMMON_H
...
#endif /* PERIODIC_TASK_APP_COVERAGETEST_COMMON_H */
