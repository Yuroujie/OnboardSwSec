 ...
 */
#ifndef DEFAULT_PERIODIC_TASK_APP_FCNCODE_VALUES_H
#define DEFAULT_PERIODIC_TASK_APP_FCNCODE_VALUES_H

/************************************************************************
 * Macro Definitions
 ************************************************************************/

#define PERIODIC_TASK_APP_CCVAL(x) PERIODIC_TASK_APP_FunctionCode_##x

enum PERIODIC_TASK_APP_FunctionCode_
{
    PERIODIC_TASK_APP_FunctionCode_NOOP          = 0,
