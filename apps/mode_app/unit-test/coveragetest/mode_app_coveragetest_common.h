 ...
 * @file
 *
 * Common definitions for all mode_app coverage tests
 */

#ifndef MODE_APP_COVERAGETEST_COMMON_H
#define MODE_APP_COVERAGETEST_COMMON_H
...
#endif /* MODE_APP_COVERAGETEST_COMMON_H */
