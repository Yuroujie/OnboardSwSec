 ...
 */
#ifndef DEFAULT_MODE_APP_MSGDEFS_H
#define DEFAULT_MODE_APP_MSGDEFS_H

#include "common_types.h"
#include "mode_app_fcncodes.h"

typedef struct MODE_APP_DisplayParam_Payload
{
...
typedef struct MODE_APP_HkTlm_Payload
{
