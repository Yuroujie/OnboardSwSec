 ...
 *   message data types.
 *
 * This is a compatibility header for the "beacon_task_app_msg.h" file that has
 ...
 * dictionary tool.
 */
#ifndef DEFAULT_BEACON_TASK_APP_MSG_H
#define DEFAULT_BEACON_TASK_APP_MSG_H

#include "beacon_task_app_mission_cfg.h"
#include "beacon_task_app_msgdefs.h"
#include "beacon_task_app_msgstruct.h"
