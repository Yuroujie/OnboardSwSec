 ...
 *   message data types.
 *
 * This is a compatibility header for the "autonomy_guard_app_msg.h" file that has
 ...
 * dictionary tool.
 */
#ifndef DEFAULT_AUTONOMY_GUARD_APP_MSG_H
#define DEFAULT_AUTONOMY_GUARD_APP_MSG_H

#include "autonomy_guard_app_mission_cfg.h"
#include "autonomy_guard_app_msgdefs.h"
#include "autonomy_guard_app_msgstruct.h"
